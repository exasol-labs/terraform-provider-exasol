...
### Added
- Provider Overview documentation via `templates/index.md.tmpl`, producing a richer Terraform Registry landing page (features, authentication notes, example, schema) instead of the bare auto-generated index
